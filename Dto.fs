...
//   | GridDto of GridDto
//   | IOInputDto of FileDto
//   | FVCOMInputDto of FVCOMInputDto
//   | NetCDFInputDto of FileDto
//   | SimulationDto of SimulationDto
  // | AdditionalModelsDataAssimilationInputDto
  // | AdditionalModelsSedimentModelInputDto
  // | AdditionalModelsBedflagInputDto
  // | AdditionalModelsIcingForcingInputDto
  // | AdditionalModelsIceForcingInputDto
  // | AirPressureInputDto of FileDto

  // | GridCoordinatesInputDto of FileDto
  // | GridCoriolisInputDto
  // | GridDepthInputDto
  // | GridSigmaLevelsInputDto
  // | GridSpongeInputDto
  // | GroundwaterInputDto
  // | HeatingInputDto of FileDto
  // | HeatingCalculateInputDto
  ...
  // | NcnestNodeInputDto
  // | NestingInputDto
  // | NestingStationInputDto

  // | OBCElevationInputDto of FileDto
  // | OBCLongshoreFlowInputDto
  // | OBCMeanFlowInputDto
  // | OBCNodeListInputDto of FileDto
  // | OBCSaltInputDto
  // | OBCTempInputDto
  // | PhysicsHorizontalMixingInputDto
  // | PhysicsBottomRoughnessInputDto
  // | ProbesInputDto
  // | PrecipitationInputDto of FileDto
  // | RiverInputDto of FileDto
  // | StartupInputDto of FileDto
  // | StartupXInputDto of FileDto
  // | WaveInputDto of FileDto
  // | WindInputDto of FileDto
